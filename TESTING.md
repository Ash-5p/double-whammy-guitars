...
| faqs | [edit_faq.html](https://github.com/Ash-5p/double-whammy-guitars/blob/main/faqs/templates/faqs/edit_faq.html) | No link provided | ![screenshot](documentation/validation/html-edit_faq.png) | No W3C link provided. Could not check by ERI due to page requiring authentication. `<section>` element lacks header `h2-h6`. This is acceptable. |
