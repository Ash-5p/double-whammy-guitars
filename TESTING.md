...
| Admin Features (Products) | Feature is expected to allow the site owner to create new products. | Created new products with valid data (name, price, description, image, category). | Products were added successfully and displayed on the site. | ![screenshot](documentation/defensive/create-product-before.png) | ![screenshot](documentation/defensive/create-product-after.png) |
...
| Admin Features (FAQs) | Feature is expected to allow the site owner to create new FAQs. | Created new FAQ with valid data (question & answer). | FAQ was added successfully and displayed on the FAQ page of the site. | ![screenshot](documentation/defensive/create-faq-before.png) | ![screenshot](documentation/defensive/create-faq-after.png) |
